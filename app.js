...
/////////////////////
                ...
                let bckg = document.querySelector(".landpage");
                let ArrayOfImages = ["bg1.jpg","bg2.jpg","bg3.jpg","bg4.jpg"];
                ...
                function RandomizeImages()
                {
                        ...
                        BackgrounInterval= setInterval(()=>
                        {
                            ...
                            bckg.style.backgroundImage=`url('./images/background/${ArrayOfImages[random]}')`;
